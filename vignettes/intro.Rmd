...
dse <- estimateDispersions(dse, minmu=1e-6)

dse <- nbinomWaldTest(dse, useT=TRUE, df=rowSums(weights)-NCOL(design),
                      minmu=1e-6)
res <- lfcShrink(dds = dse, contrast=c("Biological_Condition", "NPC", "GW16"),
                 type = "normal")
head(res)
```
