...
author: "Davide Risso"
date: "Last modified: May 12, 2017; Compiled: `r format(Sys.time(), '%B %d, %Y')`"
...
to fit the ZINB model. Note that we use only one CPU here, but one can select
the number of cores with the option `ncore`, to speed up computations.
